...
var solveHanoi = function(numDisks, fromPeg, toPeg) {
    ...
    // recursive case:
    var sparePeg = hanoi.getSparePeg(fromPeg, toPeg); //retorna prego reserva
    solveHanoi(numDisks-1,fromPeg, sparePeg); //move n-1 discos para prego reserva
    hanoi.moveDisk(fromPeg, toPeg); //move disco n para o prego destino
    solveHanoi(numDisks-1,sparePeg, toPeg); //move os n-1 discos do prego reserva para o prego destino
};
